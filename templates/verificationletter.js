  ...
  return `
    ...
    <body style="font-family: Arial, sans-serif; background-color: #f6f6f6; margin: 0; padding: 40px;">
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; padding: 30px;">
              ...
              <a href="${process.env.BASE_URL}api/auth/verify/${verificationToken}" target="_blank" style="display: block; width: 200px; margin: 30px auto; text-align: center; background: linear-gradient(135deg, #ffffff, #f1f1f1); padding: 12px 0; text-decoration: none; border-radius: 4px; font-weight: bold; font-size: 16px; color: #94A3B4;  border: 0.4px solid rgba(33, 33, 33, 0.1)">Підтвердити</a>
